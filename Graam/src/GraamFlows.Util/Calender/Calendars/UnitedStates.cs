namespace GraamFlows.Util.Calender.Calendars;
...
public class UnitedStates : Calendar
{
    ...
    public UnitedStates(Market m)
    {
        switch (m)
        {
            case Market.Settlement:
                _calendar = Settlement.Singleton;
                break;
            case Market.NYSE:
                _calendar = NYSE.Singleton;
                break;
            case Market.GovernmentBond:
                _calendar = GovernmentBond.Singleton;
                break;
            case Market.NERC:
                _calendar = NERC.Singleton;
                break;
            default:
    ...
    public class Settlement : WesternImpl
    {
    ...
    public class GovernmentBond : WesternImpl
    {
